function Run(data) {
  ...
  var linesFromMatrixOne = LZString.decompressFromBase64(data[1]).split(";");
  var linesFromMatrixTwo = LZString.decompressFromBase64(data[2]).split(";");
  ...
  return [data[0], '' + LZString.compressToBase64(string)];
}